// src/app/(master)/torre-controle/logs/page.tsx
...
export default function TorreControleLogsPage() {
  const {
    leads,
    loading,
    error,
    ...
    <PageContainer>
      <div className="space-y-6">
        <PageHeader
          ...
          title="Logs"
          subtitle="Visualização operacional baseada em eventos e comportamento dos leads."
        />
